...
/**
 * Copy of LazyInitializer from apache commons-lang because I didn't want to pull in the whole aapche lib just
 * for this. Only change is the removal of the use of ConcurrentException (initialize() doesn't throw it)
 * @param <T>
 */
