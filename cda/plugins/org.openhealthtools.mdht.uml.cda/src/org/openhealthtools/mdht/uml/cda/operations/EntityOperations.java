 ...
 * '<em><b>Entity</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class EntityOperations extends org.openhealthtools.mdht.uml.hl7.rim.operations.EntityOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_DETERMINER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(entity))
		{
			if (diagnostics != null)
			{
				diagnostics.add(
						new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE, CDAValidator.ENTITY__DETERMINER_CODE,
