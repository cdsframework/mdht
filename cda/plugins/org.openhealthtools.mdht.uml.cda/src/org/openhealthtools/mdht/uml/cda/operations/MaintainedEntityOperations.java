...
/**
 * <!-- begin-user-doc -->
 * A static utility class that provides operations related to '<em><b>Maintained
 * Entity</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class MaintainedEntityOperations extends RoleOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(maintainedEntity))
		{
			if (diagnostics != null)
			{
