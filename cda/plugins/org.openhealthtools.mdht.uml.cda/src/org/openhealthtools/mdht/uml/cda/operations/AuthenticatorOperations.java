 ...
 * '<em><b>Authenticator</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class AuthenticatorOperations extends ParticipationOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(authenticator))
		{
			if (diagnostics != null)
			{
				diagnostics.add(
						new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE, CDAValidator.AUTHENTICATOR__TYPE_CODE,
								org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic",
										new Object[] { "validateTypeCode",
												org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(authenticator,
														context) }), new Object[] { authenticator }));
			}
			return false;
		}
		return true;
