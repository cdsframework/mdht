 ...
 * '<em><b>Section</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class SectionOperations extends ActOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(section))
		{
			if (diagnostics != null)
			{
				diagnostics.add(
						new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE, CDAValidator.SECTION__CLASS_CODE,
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(section))
		{
			if (diagnostics != null)
			{
				diagnostics.add(
						new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE, CDAValidator.SECTION__MOOD_CODE,
								org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic",
										new Object[] { "validateMoodCode",
												org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(section, context) }), new Object [] { section }));
			}
			return false;
		}
		return true;
	 ...
	 * @see #getActs(Section)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> GET_ACTS__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				...
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(29));
					try
					{
						return helper.createQuery(GET_ACTS__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(GET_ACTS__EOCL_QRY.get());
	 ...
	 * @see #getEncounters(Section)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> GET_ENCOUNTERS__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(31));
					try
					{
						return helper.createQuery(GET_ENCOUNTERS__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(GET_ENCOUNTERS__EOCL_QRY.get());
		@SuppressWarnings("unchecked")
	 ...
	 * @ordered
	 */
    protected static final String GET_OBSERVATIONS__EOCL_EXP =
	 ...
	 * @see #getObservations(Section)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> GET_OBSERVATIONS__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(32));
					try
					{
						return helper.createQuery(GET_OBSERVATIONS__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(GET_OBSERVATIONS__EOCL_QRY.get());
		@SuppressWarnings("unchecked")
	 ...
	 * @ordered
	 */
    protected static final String GET_OBSERVATION_MEDIA__EOCL_EXP =
	 ...
	 * @see #getObservationMedia(Section)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> GET_OBSERVATION_MEDIA__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(33));
					try
					{
						return helper.createQuery(GET_OBSERVATION_MEDIA__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(GET_OBSERVATION_MEDIA__EOCL_QRY.get());
		@SuppressWarnings("unchecked")
	 ...
	 * @ordered
	 */
	protected static final String GET_ORGANIZERS__EOCL_EXP =
	 ...
	 * @see #getOrganizers(Section)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> GET_ORGANIZERS__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(34));
					try
					{
						return helper.createQuery(GET_ORGANIZERS__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(GET_ORGANIZERS__EOCL_QRY.get());
		@SuppressWarnings("unchecked")
	 ...
	 * @ordered
	 */
	protected static final String GET_PROCEDURES__EOCL_EXP =
	 ...
	 * @see #getProcedures(Section)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> GET_PROCEDURES__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(35));
					try
					{
						return helper.createQuery(GET_PROCEDURES__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(GET_PROCEDURES__EOCL_QRY.get());
		@SuppressWarnings("unchecked")
	 ...
	 * @ordered
	 */
	protected static final String GET_REGIONS_OF_INTEREST__EOCL_EXP =
	 ...
	 * @see #getRegionsOfInterest(Section)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> GET_REGIONS_OF_INTEREST__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(36));
					try
					{
						return helper.createQuery(GET_REGIONS_OF_INTEREST__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(GET_REGIONS_OF_INTEREST__EOCL_QRY.get());
		@SuppressWarnings("unchecked")
	...
	protected static final LazyInitializer<OCLExpression<EClassifier>> GET_SECTIONS__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				...
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(37));
					try
					{
	 ...
	 * @ordered
	 */
	protected static final String GET_SUBSTANCE_ADMINISTRATIONS__EOCL_EXP =
	 ...
	 * @see #getSubstanceAdministrations(Section)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> GET_SUBSTANCE_ADMINISTRATIONS__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(39));
					try
					{
						return helper.createQuery(GET_SUBSTANCE_ADMINISTRATIONS__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(GET_SUBSTANCE_ADMINISTRATIONS__EOCL_QRY.get());
		@SuppressWarnings("unchecked")
	 ...
	 * @ordered
	 */
	protected static final String GET_SUPPLIES__EOCL_EXP =
	 ...
	 * @see #getSupplies(Section)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> GET_SUPPLIES__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(40));
					try
					{
						return helper.createQuery(GET_SUPPLIES__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(GET_SUPPLIES__EOCL_QRY.get());
		@SuppressWarnings("unchecked")
	 ...
	 * @ordered
	 */
	protected static final String HAS_ACT_TEMPLATE__STRING__EOCL_EXP =
	 ...
	 * @see #hasActTemplate(Section, java.lang.String)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_ACT_TEMPLATE__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(41));
					try
					{
						return helper.createQuery(HAS_ACT_TEMPLATE__STRING__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(HAS_ACT_TEMPLATE__STRING__EOCL_QRY.get());
	...
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_CODE__STRING_STRING_STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				...
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(42));
					try
					{
	 ...
	 * @ordered
	 */
	protected static final String HAS_ENCOUNTER_TEMPLATE__STRING__EOCL_EXP =
	 ...
	 * @see #hasEncounterTemplate(Section, java.lang.String)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_ENCOUNTER_TEMPLATE__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(43));
					try
					{
						return helper.createQuery(HAS_ENCOUNTER_TEMPLATE__STRING__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(HAS_ENCOUNTER_TEMPLATE__STRING__EOCL_QRY.get());
		EvaluationEnvironment<?, ?, ?, ?, ?> environment = query.getEvaluationEnvironment();
		environment.add("templateId", templateId);
		return ((Boolean) query.evaluate(section)).booleanValue();
	}
	 ...
	 * @ordered
	 */
	protected static final String HAS_OBSERVATION_MEDIA_TEMPLATE__STRING__EOCL_EXP =
	 ...
	 * @see #hasObservationMediaTemplate(Section, java.lang.String)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_OBSERVATION_MEDIA_TEMPLATE__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(44));
					try
					{
						return helper.createQuery(HAS_OBSERVATION_MEDIA_TEMPLATE__STRING__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(HAS_OBSERVATION_MEDIA_TEMPLATE__STRING__EOCL_QRY.get());
		EvaluationEnvironment<?, ?, ?, ?, ?> environment = query.getEvaluationEnvironment();
		environment.add("templateId", templateId);
		return ((Boolean) query.evaluate(section)).booleanValue();
	}
	 ...
	 * @ordered
	 */
	protected static final String HAS_OBSERVATION_TEMPLATE__STRING__EOCL_EXP =
	 ...
	 * @see #hasObservationTemplate(Section, java.lang.String)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_OBSERVATION_TEMPLATE__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(45));
					try
					{
						return helper.createQuery(HAS_OBSERVATION_TEMPLATE__STRING__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(HAS_OBSERVATION_TEMPLATE__STRING__EOCL_QRY.get());
		EvaluationEnvironment<?, ?, ?, ?, ?> environment = query.getEvaluationEnvironment();
		environment.add("templateId", templateId);
		return ((Boolean) query.evaluate(section)).booleanValue();
	}
	 ...
	 * @ordered
	 */
	protected static final String HAS_ORGANIZER_TEMPLATE__STRING__EOCL_EXP =
	 ...
	 * @see #hasOrganizerTemplate(Section, java.lang.String)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_ORGANIZER_TEMPLATE__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(46));
					try
					{
						return helper.createQuery(HAS_ORGANIZER_TEMPLATE__STRING__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(HAS_ORGANIZER_TEMPLATE__STRING__EOCL_QRY.get());
		EvaluationEnvironment<?, ?, ?, ?, ?> environment = query.getEvaluationEnvironment();
		environment.add("templateId", templateId);
		return ((Boolean) query.evaluate(section)).booleanValue();
	}
	 ...
	 * @ordered
	 */
	protected static final String HAS_PROCEDURE_TEMPLATE__STRING__EOCL_EXP =
	 ...
	 * @see #hasProcedureTemplate(Section, java.lang.String)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_PROCEDURE_TEMPLATE__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(47));
					try
					{
						return helper.createQuery(HAS_PROCEDURE_TEMPLATE__STRING__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(HAS_PROCEDURE_TEMPLATE__STRING__EOCL_QRY.get());
		EvaluationEnvironment<?, ?, ?, ?, ?> environment = query.getEvaluationEnvironment();
		environment.add("templateId", templateId);
		return ((Boolean) query.evaluate(section)).booleanValue();
	}
	 ...
	 * @ordered
	 */
	protected static final String HAS_REGION_OF_INTEREST_TEMPLATE__STRING__EOCL_EXP =
	 ...
	 * @see #hasRegionOfInterestTemplate(Section, java.lang.String)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_REGION_OF_INTEREST_TEMPLATE__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(48));
					try
					{
						return helper.createQuery(HAS_REGION_OF_INTEREST_TEMPLATE__STRING__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(HAS_REGION_OF_INTEREST_TEMPLATE__STRING__EOCL_QRY.get());
		EvaluationEnvironment<?, ?, ?, ?, ?> environment = query.getEvaluationEnvironment();
		environment.add("templateId", templateId);
		return ((Boolean) query.evaluate(section)).booleanValue();
	}
	 ...
	 * @ordered
	 */
	protected static final String HAS_SUBSTANCE_ADMINISTRATION_TEMPLATE__STRING__EOCL_EXP =
	 ...
	 * @see #hasSubstanceAdministrationTemplate(Section, java.lang.String)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_SUBSTANCE_ADMINISTRATION_TEMPLATE__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(49));
					try
					{
						return helper.createQuery(HAS_SUBSTANCE_ADMINISTRATION_TEMPLATE__STRING__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	{
		OCL.Query query = EOCL_ENV.createQuery(HAS_SUBSTANCE_ADMINISTRATION_TEMPLATE__STRING__EOCL_QRY.get());
		EvaluationEnvironment<?, ?, ?, ?, ?> environment = query.getEvaluationEnvironment();
		environment.add("templateId", templateId);
		return ((Boolean) query.evaluate(section)).booleanValue();
	}
	...
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_SECTION_TEMPLATE__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				...
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(50));
					try
					{
	 ...
	 */
	protected static final String HAS_SUPPLY_TEMPLATE__STRING__EOCL_EXP =
	 ...
	 * @see #hasSupplyTemplate(Section, java.lang.String)
	 */
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_SUPPLY_TEMPLATE__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				@Override
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(51));
					try
					{
						return helper.createQuery(HAS_SUPPLY_TEMPLATE__STRING__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
	...
	public static boolean hasSupplyTemplate(Section section, String templateId) {
		OCL.Query query = EOCL_ENV.createQuery(HAS_SUPPLY_TEMPLATE__STRING__EOCL_QRY.get());
		EvaluationEnvironment<?, ?, ?, ?, ?> environment = query.getEvaluationEnvironment();
		environment.add("templateId", templateId);
		return ((Boolean) query.evaluate(section)).booleanValue();
	}
	...
	protected static final LazyInitializer<OCLExpression<EClassifier>> HAS_TEMPLATE_ID__STRING__EOCL_QRY =
			new LazyInitializer<OCLExpression<EClassifier>>()
			{
				...
				protected OCLExpression<EClassifier> initialize()
				{
					OCL.Helper helper = EOCL_ENV.createOCLHelper();
					helper.setOperationContext(CDAPackage.Literals.SECTION,
							CDAPackage.Literals.SECTION.getEAllOperations().get(52));
					try
					{
