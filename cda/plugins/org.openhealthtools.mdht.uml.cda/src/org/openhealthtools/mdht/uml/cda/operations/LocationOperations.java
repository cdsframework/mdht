 ...
 * '<em><b>Location</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class LocationOperations extends ParticipationOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(location))
		{
			if (diagnostics != null)
			{
				diagnostics.add(
						new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE, CDAValidator.LOCATION__TYPE_CODE,
