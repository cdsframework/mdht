 ...
 * '<em><b>Component2</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class Component2Operations extends ActRelationshipOperations {
	 ...
	 * @see #validateBodyChoice(Component2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	protected static final LazyInitializer<Constraint> VALIDATE_BODY_CHOICE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV =
			new LazyInitializer<Constraint>()
			{
				...
				protected Constraint initialize()
				{
					...
					try
					{
						return helper.createInvariant(VALIDATE_BODY_CHOICE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
					}
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_BODY_CHOICE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(component2))
		{
			if (diagnostics != null)
			{
				diagnostics.add(
						new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE, CDAValidator.COMPONENT2__BODY_CHOICE,
								org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic",
										new Object[] { "validateBodyChoice",
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(component2))
		{
			if (diagnostics != null)
			{
				diagnostics.add(
						new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE, CDAValidator.COMPONENT2__TYPE_CODE,
								org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic",
	 ...
	 * @see #validateContextConductionInd(Component2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	protected static final LazyInitializer<Constraint> VALIDATE_CONTEXT_CONDUCTION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV =
			new LazyInitializer<Constraint>()
			{
				@Override
				protected Constraint initialize()
				{
					...
					try
					{
						return helper.createInvariant(VALIDATE_CONTEXT_CONDUCTION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
					}
					catch (ParserException pe)
					{
						throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    public static boolean validateContextConductionInd(Component2 component2, DiagnosticChain diagnostics,
			Map<Object, Object> context)
	{
		if (!EOCL_ENV.createQuery(VALIDATE_CONTEXT_CONDUCTION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(component2))
		{
			if (diagnostics != null)
			{
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE,
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic",
								new Object[] { "validateContextConductionInd",
										org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(component2, context) }),
						 new Object [] { component2 }));
			}
			return false;
