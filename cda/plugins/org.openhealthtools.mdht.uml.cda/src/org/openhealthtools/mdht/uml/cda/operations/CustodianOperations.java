 ...
 * '<em><b>Custodian</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class CustodianOperations extends ParticipationOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(custodian))
		{
			if (diagnostics != null)
			{
				diagnostics.add(
						new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE, CDAValidator.CUSTODIAN__TYPE_CODE,
