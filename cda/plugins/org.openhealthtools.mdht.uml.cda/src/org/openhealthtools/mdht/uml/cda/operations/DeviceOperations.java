 ...
 * '<em><b>Device</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class DeviceOperations extends EntityOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_DETERMINER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(device))
		{
			if (diagnostics != null)
			{
				diagnostics.add(
						new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE, CDAValidator.DEVICE__DETERMINER_CODE,
