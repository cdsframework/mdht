...
/**
 * <!-- begin-user-doc -->
 * A static utility class that provides operations related to '<em><b>In
 * Fulfillment Of</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class InFulfillmentOfOperations extends ActRelationshipOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(inFulfillmentOf))
		{
			if (diagnostics != null)
			{
