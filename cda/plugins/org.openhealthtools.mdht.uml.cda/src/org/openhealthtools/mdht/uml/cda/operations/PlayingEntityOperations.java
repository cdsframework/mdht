...
/**
 * <!-- begin-user-doc -->
 * A static utility class that provides operations related to '<em><b>Playing
...
public class PlayingEntityOperations extends EntityOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_DETERMINER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(playingEntity))
		{
			if (diagnostics != null)
			{
