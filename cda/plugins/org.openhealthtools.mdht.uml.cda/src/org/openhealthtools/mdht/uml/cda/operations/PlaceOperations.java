...
public class PlaceOperations extends EntityOperations
{
   ...
   * @ordered
   */
  protected static final String VALIDATE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP =
   ...
   * @ordered
   */
  protected static final String VALIDATE_DETERMINER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP =
   ...
   * @ordered
   */
  protected static LazyInitializer<OCLExpression<EClassifier>> GET_NAMES__EOCL_QRY =
      new LazyInitializer<OCLExpression<EClassifier>>()
      {
        ...
        protected OCLExpression<EClassifier> initialize()
        {
          ...
          {
            throw new UnsupportedOperationException(pe.getLocalizedMessage(), pe);
          }
        }
      };
   ...
   * @ordered
   */
  protected static LazyInitializer<OCLExpression<EClassifier>> GET_ADDRS__EOCL_QRY =
      new LazyInitializer<OCLExpression<EClassifier>>()
      {
        @Override
        protected OCLExpression<EClassifier> initialize()
