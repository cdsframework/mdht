 ...
 * '<em><b>Component5</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class Component5Operations extends ActRelationshipOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(component5))
		{
			if (diagnostics != null)
			{
				diagnostics.add(
						new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE, CDAValidator.COMPONENT5__TYPE_CODE,
    ...
    public static boolean validateContextConductionInd(Component5 component5, DiagnosticChain diagnostics,
			Map<Object, Object> context)
	{
		if (!EOCL_ENV.createQuery(VALIDATE_CONTEXT_CONDUCTION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(component5))
		{
			if (diagnostics != null)
			{
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE,
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic",
								new Object[] { "validateContextConductionInd",
										org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(component5, context) }), new Object [] { component5 }));
			}
			return false;
		}
		return true;
