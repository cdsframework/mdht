...
/**
 * <!-- begin-user-doc -->
 * A static utility class that provides operations related to '<em><b>External
 * Procedure</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
...
public class ExternalProcedureOperations extends ActOperations {
	...
	{
		if (!EOCL_ENV.createQuery(VALIDATE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(externalProcedure))
		{
			if (diagnostics != null)
			{
    ...
    public static boolean validateMoodCode(ExternalProcedure externalProcedure, DiagnosticChain diagnostics,
			Map<Object, Object> context)
	{
		if (!EOCL_ENV.createQuery(VALIDATE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(externalProcedure))
		{
			if (diagnostics != null)
			{
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, CDAValidator.DIAGNOSTIC_SOURCE,
